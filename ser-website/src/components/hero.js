...
export default function Hero() {
    return (
        <div className="hero h-full py-32 imag3" style={{ backgroundImage: `url(igor-surkov-V1MmxRWWlB8-unsplash.jpg)`, backgroundPositionY: 0, backgroundPositionX: 0, backgroundSize: "cover",}}>
